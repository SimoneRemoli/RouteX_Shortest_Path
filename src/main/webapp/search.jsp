    ...
    <script>
        ...
        const cityStations = {
            "Rome": [
                ...
                "Subaugusta", "Cinecittà", "Anagnina", "Monte Compatri-Pantano", "Graniti",
            ...
            "Naples": ["Piscinola", "Chiaiano", "Frullone", "Colli Aminei", "Policlinico", "Rione Alto", "Montedonzelli",
                       "Medaglie d'Oro", "Vanvitelli", "Quattro Giornate", "Salvator Rosa", "Materdei", "Museo", "Dante",
                       "Toledo", "Università", "Garibaldi", "Gianturco", "Centro Direzionale", "Poggioreale", "Tribunale",
                       "Santa Maria del Pianto", "Argine Palasport", "Volla", "Salice", "Cercola", "Madonnelle", "Bartolo Longo",
                       "Villa Visconti", "San Giorgio a Cremano", "Cavalli di Bronzo", "Portici Via Libertà", "Portici Bellavista",
                       "Via Gianturco", "Piazza Garibaldi", "Museo", "Montesanto", "San Giovanni a Teduccio", "Barra", "Ponticelli",
                       "Volla", "Casalnuovo", "Talona", "La Pigna", "Botteghelle", "Centro Direzionale", "Poggioreale"],
