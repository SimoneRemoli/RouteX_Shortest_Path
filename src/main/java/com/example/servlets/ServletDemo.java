...
public class ServletDemo extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            String isDisabledTraveler = "";
            HttpSession session = request.getSession(false);

            if (session != null)
                isDisabledTraveler = (String) session.getAttribute("disabile");
            else
                isDisabledTraveler = request.getParameter("disabledTraveler");
            ...
            if (!rI.checkStazione(city, startStation, endStation)) {
            ...
            if (city.equals("Budapest")) {
                metropoli = new Budapest();
            }
            if (city.equals("Stockholm")) {
                metropoli = new Stockholm();
            }
            ...
            for (int i = 0; i < Percorsi_Con_Nomi.size(); i++)
                System.out.print(" " + Percorsi_Con_Nomi.get(i) + " ---> ");
            ...
            if (Sequenze_nodi_cruciali_full.isEmpty()) {
            ...
            if (session != null) {
                ...
                if (request.getAttribute("codiceFiscale") != null) {
                    RouteInfo info = new RouteInfo(request);
